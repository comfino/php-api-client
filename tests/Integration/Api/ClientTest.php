...
/**
 * Integration tests for the API client against the ComfinoPay sandbox environment.
 *
...
final class ClientTest extends TestCase
{
    ...
    public function testGetFinancialProductsWithLoanType(): void
    {
        ...
        $criteria = new LoanQueryCriteria(loanAmount: 150000, loanType: $productTypesResponse->productTypes[0]);
