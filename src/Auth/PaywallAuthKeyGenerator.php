...
/**
 * Time-limited HMAC-signed auth token generator for the ComfinoPay Paywall V3 iframe API endpoint.
 *
...
{
    /**
     * Generates a time-limited HMAC-signed auth token for the ComfinoPay Paywall V3 iframe.
     *
     * @param string $widgetKey Unique widget key for ComfinoPay account (36 characters, UUIDv4)
     * @param string $apiKey Unique authentication API key for ComfinoPay account
     *
