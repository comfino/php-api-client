...
/**
 * HMAC-signed auth token generator for the ComfinoPay frontend error reporting endpoint.
 *
...
final class FrontendLogAuthKeyGenerator
{
    ...
    /**
     * Generates an HMAC-signed auth token for the ComfinoPay frontend error reporting endpoint.
     *
