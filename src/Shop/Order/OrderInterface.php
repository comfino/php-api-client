...
/**
 * Order interface representing a deferred payment transaction with ComfinoPay payment gateway.
 */
interface OrderInterface
{
     ...
     *
     * @return string Shop internal order ID sent as external ID to the ComfinoPay API
     */
    public function getId(): string;

    /**
     * Callback URL used by ComfinoPay API for sending notifications about transaction status changes.
     *
     * @return string|null URL of the ComfinoPay API callback
     */
    ...
    /**
     * Returns per-product-type term constraints for this order, or null when no constraints are set.
     *
