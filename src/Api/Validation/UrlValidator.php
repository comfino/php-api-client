...
/**
 * Single source of truth for "is this a safe Comfino destination URL".
 *
...
final class UrlValidator
{
     ...
     * the Comfino dev environment uses (e.g. `widget-comfino.test`, `api-ecommerce.comfino.test`). Multi-label hosts
    ...
    /**
     * Returns true when $url is an acceptable Comfino destination.
     *
     * Rules (in order):
     ...
     * 5. Multi-label hostnames: HTTPS only, and must end with an allowed Comfino domain.
     *
