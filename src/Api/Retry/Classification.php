...
/**
 * The classifier's answer for one error or response: whether to retry, and if the far side asked us to wait, for how
 * long.
 */
final class Classification
{
     ...
     * @param int|null $retryAfterMs Delay requested by the response (Retry-After), already clamped, or null when the
