...
final class Psr18ErrorDetector
{
    ...
    public function isRetryable(Throwable $e): bool
    {
        ...
        /* Secondary: ClientExceptionInterface explicitly coded as curl timeout (code 28). This catches adapters that
           rethrow platform-specific timeout exceptions using the curl error code but do not implement NetworkExceptionInterface. */
