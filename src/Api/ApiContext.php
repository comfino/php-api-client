...
final class ApiContext
{
    ...
    public function __construct(
        ...
        if ($this->apiBaseUrl !== null && !UrlValidator::isAllowedUrl($this->apiBaseUrl)) {
            throw new InvalidArgumentException(
                "API base URL '{$this->apiBaseUrl}' is not allowed. Accepted: Comfino domains (" .
    ...
    public function getApiBaseUrl(): string
    {
        return $this->apiBaseUrl ?? (
            $this->sandboxMode ? AbstractClient::SANDBOX_API_BASE_URL : AbstractClient::PRODUCTION_API_BASE_URL
        );
    }
