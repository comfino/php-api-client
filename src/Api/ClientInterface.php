...
/**
 * ComfinoPay API client interface.
 */
interface ClientInterface
{
    ...
    /**
     * Returns the complete shop user settings (feature flags with their per-flag attributes) for an authorized
     * shop account.
     *
     * @return GetUserSettingsResponse The response containing flag attributes keyed by flag name
     *
     * @throws ConnectionTimeout On network timeout
     * @throws HttpErrorExceptionInterface On HTTP 4xx/5xx responses
     * @throws ClientExceptionInterface On PSR-18 transport errors
    ...
    /**
     * Returns the list of e-commerce platforms supported by the ComfinoPay integration.
     *
     ...
     *
     * Call this before an API key has been set (construct the client with a `null` key, or call
     * {@see setApiKey('')}) - the account does not exist yet, so there is nothing to authenticate the call with. A
     * shop already registered under {@see UserRegistration::$webSiteUrl} is rejected with HTTP 409 - see
     * {@see \Comfino\Api\Exception\Conflict}.
     *
     ...
     * {@see createUser()}.
     *
     * @return FetchAgreementsResponse
     *
     * @throws ConnectionTimeout On network timeout
     * @throws HttpErrorExceptionInterface On HTTP 4xx/5xx responses
     * @throws ClientExceptionInterface On PSR-18 transport errors
