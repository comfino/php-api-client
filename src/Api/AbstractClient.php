...
abstract class AbstractClient implements ClientInterface
{
     ...
     *
     * Use this to reach a new or undocumented endpoint (or one this library hasn't caught up with yet) without
     * waiting for a dedicated Request/Response pair to be added here. Reuses the same authentication, track ID, and
    ...
    public function sendCustomRequest(
        ...
        $this->request = $request->setSerializer($this->serializer);

        return new $responseClass($this->request, $this->sendRequest($this->request, $apiVersion), $this->serializer);
    }
