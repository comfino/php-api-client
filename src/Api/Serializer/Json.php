...
final class Json implements SerializerInterface
{
     ...
     * @param int $flags Optional JSON encoding flags to merge with defaults (defaults to 0 - use defaults only)
     *
    ...
    {
        try {
            $serializedRequestBody = json_encode($requestData, JSON_THROW_ON_ERROR | JSON_PRESERVE_ZERO_FRACTION | $flags);
