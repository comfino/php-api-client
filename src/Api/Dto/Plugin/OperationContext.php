...
enum OperationContext: string
{
    ...
    /** Creating an order in the ComfinoPay system. */
    ...
    /** Low-level communication with the ComfinoPay API. */
    case ApiCommunication = 'api_communication';

    /** Reading or saving plugin configuration / settings. */
    case Configuration = 'configuration';

    /** Synchronizing shop state (catalogue, environment) with ComfinoPay. */
