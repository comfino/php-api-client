...
/**
 * Forward-compatible container for widget types returned by the ComfinoPay API that are not yet defined
 * in {@see WidgetType}.
 *
 ...
 *
 * Obtain instances exclusively through {@see WidgetType::fromApiValue()} rather than constructing this class directly.
 */
final class UnknownWidgetType implements WidgetTypeInterface
{
    /**
